(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".location-info__slider_front ")) new core(".location-info__slider_front", {
        ...
        if (document.querySelector(".location-info__slider_reverse ")) new core(".location-info__slider_reverse", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    da.init();
    const cards = document.querySelectorAll(".slide-location__single");
    function flipCard() {
        this.classList.toggle("flip");
    }
    if (cards.length > 0) cards.forEach((card => card.addEventListener("click", flipCard)));
    window["FLS"] = false;
    isWebp();
    tabs();
    formQuantity();
